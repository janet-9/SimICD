...
function outputFile = runATPSimulation_RAMP_focal(Simscript, mesh, conmul, input_state, tend, check, ATP_start, ATP_cl, ATP_dec, ATP_Min_Cycle, ATP_pls, nprocs, pythonExe)
