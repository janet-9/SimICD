function [ICD_diagnosis, EGM, EGM_features, ICD_sense_state, ICD_sense_param] = monitor_redetect_focal(simulationDuration, outputFile, EGM_name, EGM_features_name, therapySigs, input_state_time, NSR_temp)
