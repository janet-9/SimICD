function [outputFile, ICD_diagnosis, pid] = ATP_Burst(outputFile, ICD_diagnosis, Input_state_time, ATP_CL, ATP_coupling, mesh, conmul, nprocs, pythonExe, Simscript, full_sim_time, bcl, strength, duration, start, output_res, check, monitor_duration)
    ...
    EGM_name = 'EGM_ATP';
    EGM_features_name = 'EGM_features_ATP';
    EGM_name_post_therapy = 'EGM_post_therapy';
    EGM_features_name_post_therapy = 'EGM_features_post_therapy';

    % Step 2: Terminate background episode simulation
    killCommand = sprintf('pkill -u k23086865 "openCARP"');
    system(killCommand);
    ...
    [EGM, EGM_features, ICD_sense_state, ICD_sense_param] = monitor_ATP(outputFile, EGM_name, EGM_features_name, tend-ATP_start);
    ...
    [ICD_diagnosis, EGM, EGM_features, ICD_sense_state, ICD_sense_param] = monitor_redetect(monitor_duration, outputFile, EGM_name_post_therapy, EGM_features_name_post_therapy, prev_therapySigs);
