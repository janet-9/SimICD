function [outputFile, Redetect_param] = ATP_Burst_Therapy_Focal(ATP_param,  nprocs, pythonExe, full_sim_time, args)
    ...
    outputFile = runATPSimulation_focal(Therapy_script, input_state, tend, ATP_start, ATP_cl, ATP_pls, nprocs, pythonExe, args);
    ...
    disp('Analysing Therapy...');
     % Step 4: Analyse the results of the ATP simulation
    disp('Analysing Therapy...');
    monitor_ATP_focal(outputFile, EGM_name, EGM_features_name, tend-ATP_start, args.EGM_template, pythonExe);
