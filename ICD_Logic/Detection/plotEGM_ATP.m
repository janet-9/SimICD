function plotEGM_ATP(EGM, EGM_features, min_length, plot_name)
    ...
    plot(EGM.VSigRaw, 'Color', [0.5, 0, 0.5], 'LineWidth', 1.5, 'DisplayName', 'Ventricular Trace Therapy'); % Darker purple
    title('Ventricular Trace: Therapy');
    set(gca, 'XTick', [], 'YTick', []);
    grid on;
    box off;
    xlim([0 min_length]);
    ...
    plot(EGM_features.events.Vin, 'Color', [0.5, 0, 0.5], 'LineWidth', 1.5, 'DisplayName', 'Ventricular Events: Therapy'); % Purple
    title('Ventricular Events: Therapy');
    set(gca, 'XTick', [], 'YTick', []);
    grid on;
    box off;
    xlim([0 min_length]);
    ...
    plot(EGM.Shock, 'Color', [0, 0.7, 0], 'LineWidth', 1.5, 'DisplayName', 'Shock Trace: Therapy'); % Dark green
    title('Shock Trace: Therapy');
    set(gca, 'XTick', [], 'YTick', []);
    grid on;
    box off;
    xlim([0 min_length]);
