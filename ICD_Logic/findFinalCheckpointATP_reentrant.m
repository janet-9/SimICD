function roeFile = findFinalCheckpointATP_reentrant(outputFile)
    ...
    folderPath = fullfile('Sim_Files', 'Episode_Sim_Scripts', 'Reentrant_VT', outputFile);
    ...
    if ~isempty(fileList)
        ...
        destinationFolderPath = fullfile('Sim_Files', 'Episode_Sim_Scripts', 'Reentrant_VT');
